  ...
  return (
    <Section className="bg-cream">
      <div className="container mx-auto px-6 text-center">
        <FadeIn>
          <h2 className="font-playfair font-bold text-4xl md:text-5xl text-charcoal mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20">
          ...
          <FadeIn delay={100} className="flex flex-col items-center">
            ...
            <h3 className="font-poppins font-semibold text-2xl text-charcoal mb-4">
              Sore, Stiff, Never Fully Recovered
            </h3>
            <p className="text-gray-600 leading-relaxed max-w-xs">
              You push through workouts, long work days, endless errands. But your muscles? They're screaming. Generic creams do nothing. You're tired of waking up tight and achy.
            </p>
          </FadeIn>
          ...
          <FadeIn delay={200} className="flex flex-col items-center">
            ...
            <h3 className="font-poppins font-semibold text-2xl text-charcoal mb-4">
              Dry, Irritated Skin That Never Heals
            </h3>
            <p className="text-gray-600 leading-relaxed max-w-xs">
              You've tried every drugstore lotion. They smell fake, feel sticky, and your skin is dry again in an hour. You deserve something that actually penetrates and nourishes.
            </p>
          </FadeIn>
          ...
          <FadeIn delay={300} className="flex flex-col items-center">
            ...
            <h3 className="font-poppins font-semibold text-2xl text-charcoal mb-4">
              No Time to Unwind, No Real Self-Care
            </h3>
            <p className="text-gray-600 leading-relaxed max-w-xs">
              You collapse into bed exhausted. No ritual. No moment of calm. Just survival mode. Your body craves a grounding routine that signals 'it's okay to relax now.'
            </p>
          </FadeIn>
        </div>
