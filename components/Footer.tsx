        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12 justify-between">
          ...
          <div className="max-w-md">
            ...
            <p className="text-gray-400 leading-relaxed mb-8">
              ...
              Crafted in Europe with organic hemp.
            </p>
          ...
          <div className="flex flex-col gap-3 md:items-end">
            ...
            <a href="https://www.endoca.com/cookie-policy?v=13b5bfe96f3e" className="text-gray-400 hover:text-white transition-colors">Cookie Policy</a>
