...
const reviews: Review[] = [
  {
    ...
    location: 'Amsterdam',
    rating: 5,
    headline: 'Finally, relief that lasts.',
    text: "I'm a runner and my legs are always sore. This salve is the only thing that's helped me actually recover. I use it every single night now.",
    productName: 'Hemp Salve',
    productId: '1'
  },
  {
    id: '2',
    ...
    text: "The body butter is unreal. I have eczema-prone skin and this is the first product that keeps me moisturized without irritation.",
        ...
        <div className="text-center mb-16">
          <FadeIn>
            <h2 className="font-playfair font-bold text-4xl md:text-5xl text-charcoal mb-12">
              12,000+ Bodies That Finally Feel at Ease
            </h2>
          </FadeIn>
              ...
              >
                <div className="glass-card bg-white/60 p-8 rounded-2xl shadow-lg border border-white mx-4">
                  ...
                  <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                    ...
                    {product && (
                       <a href={product.link} className="flex items-center gap-3 group hover:opacity-80 transition-opacity">
                         <div className="w-10 h-10 rounded-md overflow-hidden bg-gray-100 border border-gray-200">
                           <img src={product.image} alt={product.name} className="w-full h-full object-cover" />
                         </div>
                         <div className="text-xs font-medium bg-teal-50 text-teal-800 px-3 py-1 rounded-full group-hover:bg-teal-100 transition-colors">
