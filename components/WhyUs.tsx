      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <WhyUsItem 
            ...
            title="European Organic Hemp"
            text="Sourced from certified farms. No pesticides. No shortcuts. Just clean, potent botanicals."
            delay={0}
          />
          <WhyUsItem 
          ...
          <WhyUsItem 
            ...
            text="We don't mass-produce. We craft in small batches to keep everything fresh and potent."
            delay={300}
          />
        </div>
      </div>
